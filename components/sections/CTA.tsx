  ...
  return (
    <section className="relative overflow-hidden py-28">
      ...
      <Container className="relative z-10">
        <div className="overflow-hidden rounded-[40px] border border-white/10 bg-white/5 px-6 py-16 text-center shadow-[0_30px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:px-8 sm:py-20 lg:px-20">
          ...
          <div className="mt-14 flex flex-wrap items-center justify-center gap-3 text-center text-sm text-slate-400">
            <ShieldCheck className="h-5 w-5 shrink-0 text-cyan-400" />

            <span>
              Trusted Process &bull; Transparent Communication &bull; Long-Term
              Partnership
            </span>
          </div>
        </div>
